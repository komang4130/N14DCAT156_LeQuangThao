...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <!-- Brand -->
  <a class="navbar-brand" href="index.php">AS-komang</a>
  ...
  <ul class="navbar-nav">
      ...
      if ( isset($_SESSION['is_logged']))
      {
        if ( $_SESSION["admin"] )
        {
          ...
          echo "<li class='nav-item'>
          <a class='nav-link' href='authorize.php' style='position: absolute;top: 8px;right: 120px;font-size: 18px;'>Upload</a>
          </li>
                <li class='nav-item'>
